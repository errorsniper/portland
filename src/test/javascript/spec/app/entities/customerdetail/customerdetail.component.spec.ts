...
import { CustomerdetailComponent } from 'app/entities/customerdetail/customerdetail.component';
...
describe('Component Tests', () => {
  describe('Customerdetail Management Component', () => {
