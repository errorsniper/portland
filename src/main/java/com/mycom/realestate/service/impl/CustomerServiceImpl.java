...
import com.mycom.realestate.repository.CustomerRepository;
import com.mycom.realestate.repository.search.CustomerSearchRepository;
import com.mycom.realestate.service.CustomerService;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<Customer> search(String query) {
        ...
        return customerSearchRepository.search(queryStringQuery(query)
            .field("name")
            .defaultOperator(Operator.AND), PageRequest.of(0,1000)).getContent();
    }
}
